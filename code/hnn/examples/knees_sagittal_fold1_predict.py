...
model_root = '/data/ruida/hed-globalweight/examples/knees_sagittal_fold1'
trained_model='hed_prostate_mask_iter_66000.caffemodel'

# TESTING
image_root='/data/ruida/knees/test_femur_extra_fold/sagittal'
out_dir = '/data/ruida/knees/femur_map_extra/sagittal' 
