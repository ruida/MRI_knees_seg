...
model_root = '/data/ruida/hed-globalweight/examples/knees_coronal_fold1'
trained_model='hed_prostate_mask_iter_92000.caffemodel'

# TESTING
image_root='/data/ruida/knees/test_femur_extra_fold/coronal'
out_dir = '/data/ruida/knees/femur_map_extra/coronal' 
